...
func TestParseFlags(t *testing.T) {
	cases := []struct {
		...
		{"booleans", []string{"-r"}, options{resume: true}},
		{"long booleans", []string{"--resume"}, options{resume: true}},
		{"permission tier", []string{"--permission", "full-auto"}, options{permission: "full-auto"}},
...
func TestParseFlagsRejects(t *testing.T) {
	cases := []struct {
		...
		{"value given to a boolean", []string{"--resume=true"}},
