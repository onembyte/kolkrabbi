...
type app struct {
	...
	// agentReport is the running screen's record of the last orchestrated
	// run, for `/agents`. Nil outside a session, where there is no screen.
	agentReport func() string
