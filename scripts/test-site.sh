...
contains index.html 'Installer ships with v1.3.4' "current installer release status is missing"
contains index.html '"softwareVersion": "1.3.4"' "structured data version drifted from the installer release"
