...
contains index.html 'Installer ships with v1.3.1' "current installer release status is missing"
contains index.html '"softwareVersion": "1.3.1"' "structured data version drifted from the installer release"
