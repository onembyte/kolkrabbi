...
contains index.html 'Chat and code' "landing page does not name the two v0.1 modes"
excludes index.html 'chat, code, and agent|agent for longer|agent mode|orchestrated agent' "landing page advertises the unreleased agent mode"
